...
"}")
        ...
        self.sortorder.setCheckable(True)
        self.sortorder.setObjectName("sortorder")
        self.openBatchOperation = QtWidgets.QAction(mainWindow)
        self.openBatchOperation.setEnabled(False)
        self.openBatchOperation.setObjectName("openBatchOperation")
        ...
        self.Utils.addAction(self.openBatchOperation)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.sortorder.setText(_translate("mainWindow", "按照字母排序"))
        self.openBatchOperation.setText(_translate("mainWindow", "批量增删  Ctrl+B"))
